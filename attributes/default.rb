...
default['phpmyadmin']['version'] = '4.8.0'
default['phpmyadmin']['checksum'] = '1e83d60627d8036261af71220eae9ffd8d3150778702720905bcfa85c40ce346'
...
when 'debian'
  ...
  default['phpmyadmin']['temp_dir'] = '/tmp'
when 'rhel'
